...
export const authConfig = {
  ...
  callbacks: {
    ...
    async authorized({ auth, request: { nextUrl } }) {
      ...
      const publicRoutes = ["/login", "/register", "/verify-email", "/forgot-password", "/reset-password", "/kiosk/", "/t/", "/dcode", "/strategy", "/research-protocol", "/guide", "/getting-started", "/terms", "/privacy"]
