export const messages = {
  ...
  commentsManager: {
    ...
    moveUp: "上へ",
    moveDown: "下へ",
    categoryGoalAchieved: "目標達成",
    categoryAlmostGoal: "あと少しで達成",
    categoryTodayZero: "今日まだゼロ",
    categoryStreak: "ストリーク継続中",
    categoryHighScore: "高スコア維持",
    categoryLowScore: "スコアが低め",
    categoryMorning: "朝の挨拶",
    categoryEvening: "夕方のねぎらい",
    categoryGeneric: "汎用（教育的コンテンツ）",
